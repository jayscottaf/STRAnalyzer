    ...
    <>
      ...
      <div className="print-report" style={{ position: 'absolute', left: '-9999px', top: 0, width: '8.5in', background: 'white', color: 'black', padding: '0.5in', fontSize: '11px', fontFamily: 'sans-serif' }}>
        <div className="mb-6 pb-4 border-b-2 border-black">
          <h1 className="text-2xl font-bold">{inputs.activeStrategy?.toUpperCase() || 'REI'} Deal Analysis Report</h1>
        ...
        <footer className="mt-8 pt-4 border-t border-gray-300 text-[9px] text-gray-600">
          Generated by REI Deal Analyzer. This report is for informational purposes only and does not constitute financial, tax, or legal advice. Consult qualified professionals before making investment decisions.
        </footer>
      </div>
    </>
  );
